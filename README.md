...
![Definitions](https://github.com/tecsmith/fork.the-via.keyboards/actions/workflows/build.yml/badge.svg)
...
3. Create a definition in JSON format for your keyboard and submit it as a pull request to [VIA's Keyboards Repository](https://github.com/the-via/keyboards) Master **[not this one]** branch.
...
***[This is a personal use fork repo.]***
